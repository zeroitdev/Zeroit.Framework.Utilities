...
namespace Zeroit.Framework.Utilities.Colors.AllColors
{
    ...
    internal static class NativeMethods
    {
        ...
        public const uint STATUS_INFO_LENGTH_MISMATCH = 3221225476;
        ...
        public const uint PDH_FMT_DOUBLE = 512;
        public const uint PDH_FMT_NOSCALE = 4096;
        public const uint PDH_FMT_NOCAP100 = 32768;
        ...
        internal class SYSTEMTIME
        {
            ...
            {
                return "[SYSTEMTIME: " + this.wDay.ToString((IFormatProvider)CultureInfo.CurrentCulture) + "/" + this.wMonth.ToString((IFormatProvider)CultureInfo.CurrentCulture) + "/" + this.wYear.ToString((IFormatProvider)CultureInfo.CurrentCulture) + " " + this.wHour.ToString((IFormatProvider)CultureInfo.CurrentCulture) + ":" + this.wMinute.ToString((IFormatProvider)CultureInfo.CurrentCulture) + ":" + this.wSecond.ToString((IFormatProvider)CultureInfo.CurrentCulture) + "]";
            }
        }
