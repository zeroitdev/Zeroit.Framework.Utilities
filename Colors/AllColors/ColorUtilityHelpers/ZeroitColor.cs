...
namespace Zeroit.Framework.Utilities.Colors.AllColors
{
    ...
    public struct ZeroitColor
    {
        ...
        {
            if (!Zeroit.Framework.Utilities.Colors.AllColors.ClientUtils.IsEnumValid((Enum)color, (int)color, 1, 174))
        ...
        {
            object namedColor = Zeroit.Framework.Utilities.Colors.AllColors.ColorConverter.GetNamedColor(name);
            if (namedColor != null)
