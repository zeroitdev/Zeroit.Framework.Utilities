    ...
    static class KnownColorTable
    {
        ...
        public static ZeroitColor ArgbToKnownColor(int targetARGB)
        {
            ...
            for (int index = 0; index < colorTable.Length; ++index)
            {
                ...
                if (argb == targetARGB)
                {
                    ZeroitColor color = ZeroitColor.FromKnownColor((Zeroit.Framework.Utilities.Colors.AllColors.KnownColor)index);
        ...
        private static void InitColorTable()
        {
            ...
            //
#if !FEATURE_PAL
            SystemEvents.UserPreferenceChanging += new Zeroit.Framework.Utilities.Colors.AllColors.UserPreferenceChangingEventHandler(OnUserPreferenceChanging);
#endif
        ...
        {
#if !FEATURE_PAL
            colorTable[(int)KnownColor.ActiveBorder] = SystemColorToArgb((int)SystemColors.ActiveBorder.ToArgb());
            colorTable[(int)KnownColor.ActiveCaption] = SystemColorToArgb((int)SystemColors.ActiveCaption.ToArgb());
            colorTable[(int)KnownColor.ActiveCaptionText] = SystemColorToArgb((int)SystemColors.ActiveCaptionText.ToArgb());
            colorTable[(int)KnownColor.AppWorkspace] = SystemColorToArgb((int)SystemColors.AppWorkspace.ToArgb());
            colorTable[(int)KnownColor.ButtonFace] = SystemColorToArgb((int)SystemColors.ButtonFace.ToArgb());
            colorTable[(int)KnownColor.ButtonHighlight] = SystemColorToArgb((int)SystemColors.ButtonHighlight.ToArgb());
            colorTable[(int)KnownColor.ButtonShadow] = SystemColorToArgb((int)SystemColors.ButtonShadow.ToArgb());
            colorTable[(int)KnownColor.Control] = SystemColorToArgb((int)SystemColors.Control.ToArgb());
            colorTable[(int)KnownColor.ControlDark] = SystemColorToArgb((int)SystemColors.ControlDark.ToArgb());
            colorTable[(int)KnownColor.ControlDarkDark] = SystemColorToArgb((int)SystemColors.ControlDarkDark.ToArgb());
            colorTable[(int)KnownColor.ControlLight] = SystemColorToArgb((int)SystemColors.ControlLight.ToArgb());
            colorTable[(int)KnownColor.ControlLightLight] = SystemColorToArgb((int)SystemColors.ControlLightLight.ToArgb());
            colorTable[(int)KnownColor.ControlText] = SystemColorToArgb((int)SystemColors.ControlText.ToArgb());
            colorTable[(int)KnownColor.Desktop] = SystemColorToArgb((int)SystemColors.Desktop.ToArgb());
            colorTable[(int)KnownColor.GradientActiveCaption] = SystemColorToArgb((int)SystemColors.GradientActiveCaption.ToArgb());
            colorTable[(int)KnownColor.GradientInactiveCaption] = SystemColorToArgb((int)SystemColors.GradientInactiveCaption.ToArgb());
            colorTable[(int)KnownColor.GrayText] = SystemColorToArgb((int)SystemColors.GrayText.ToArgb());
            colorTable[(int)KnownColor.Highlight] = SystemColorToArgb((int)SystemColors.Highlight.ToArgb());
            colorTable[(int)KnownColor.HighlightText] = SystemColorToArgb((int)SystemColors.HighlightText.ToArgb());
            colorTable[(int)KnownColor.HotTrack] = SystemColorToArgb((int)SystemColors.HotTrack.ToArgb());
            colorTable[(int)KnownColor.InactiveBorder] = SystemColorToArgb((int)SystemColors.InactiveBorder.ToArgb());
            colorTable[(int)KnownColor.InactiveCaption] = SystemColorToArgb((int)SystemColors.InactiveCaption.ToArgb());
            colorTable[(int)KnownColor.InactiveCaptionText] = SystemColorToArgb((int)SystemColors.InactiveCaptionText.ToArgb());
            colorTable[(int)KnownColor.Info] = SystemColorToArgb((int)SystemColors.Info.ToArgb());
            colorTable[(int)KnownColor.InfoText] = SystemColorToArgb((int)SystemColors.InfoText.ToArgb());
            colorTable[(int)KnownColor.Menu] = SystemColorToArgb((int)SystemColors.Menu.ToArgb());
            colorTable[(int)KnownColor.MenuBar] = SystemColorToArgb((int)SystemColors.MenuBar.ToArgb());
            colorTable[(int)KnownColor.MenuHighlight] = SystemColorToArgb((int)SystemColors.MenuHighlight.ToArgb());
            colorTable[(int)KnownColor.MenuText] = SystemColorToArgb((int)SystemColors.MenuText.ToArgb());
            colorTable[(int)KnownColor.ScrollBar] = SystemColorToArgb((int)SystemColors.ScrollBar.ToArgb());
            colorTable[(int)KnownColor.Window] = SystemColorToArgb((int)SystemColors.Window.ToArgb());
            colorTable[(int)KnownColor.WindowFrame] = SystemColorToArgb((int)SystemColors.WindowFrame.ToArgb());
            colorTable[(int)KnownColor.WindowText] = SystemColorToArgb((int)SystemColors.WindowText.ToArgb());
#else
