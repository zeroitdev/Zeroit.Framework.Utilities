...
// ***********************************************************************
// <copyright file="BitmapGaussianKernelCalculator.cs" company="Zeroit Dev Technologies">
...
{
    /// <summary>
    /// A Gaussian Kernel Calculator class
    /// </summary>
    public static class GaussianKernelCalculator
    {
        /// <summary>
        /// Copy to Canvas
        /// </summary>
        ...
        /// <param name="factor">Set Factor. Default is 1</param>
        /// <param name="bias">Set Bias. Default is 0</param>
        /// <returns></returns>
