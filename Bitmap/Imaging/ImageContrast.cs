...
// ***********************************************************************
// <copyright file="ImageContrast.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Utilities.BitmapUtils.Imaging
{
    ...
    /// <summary>
    /// A class collection for Image contrast
    /// </summary>
    public static class ImageContrast
    {
        ...
        /// </summary>
        /// <param name="sourceBitmap">Set source Bitmap</param>
        /// <param name="threshold">Set threshold value</param>
        /// <returns></returns>
        public static System.Drawing.Bitmap Contrast(this System.Drawing.Bitmap sourceBitmap, int threshold)
        {
