...
// ***********************************************************************
// <copyright file="BitwiseBitmapBlend.cs" company="Zeroit Dev Technologies">
...
{
    /// <summary>
    /// A class collection for Bitwise Blending (Exended version)
    /// </summary>
    public static class BitwiseBlendAdv
    {
        /// <summary>
        /// Copy to canvas
        /// </summary>
