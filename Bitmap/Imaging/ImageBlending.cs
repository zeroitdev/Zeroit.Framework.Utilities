...
// ***********************************************************************
// <copyright file="ImageBlending.cs" company="Zeroit Dev Technologies">
...
{
    /// <summary>
    /// A class collection for Image Blending
    /// </summary>
    public static class ImageBlending
    {
        ...
        /// <returns></returns>
        public static byte CalculateColorComponentBlendValue(float source, float overlay, ImageBlendingColorComponentBlendType blendType)
        {
            float resultValue = 0;
            byte resultByte = 0;

            if (blendType == ImageBlendingColorComponentBlendType.Add)
            {
                resultValue = source + overlay;
            }
            else if (blendType == ImageBlendingColorComponentBlendType.Subtract)
            {
                resultValue = source - overlay;
            }
            else if (blendType == ImageBlendingColorComponentBlendType.Average)
            {
                resultValue = (source + overlay) / 2.0f;
            }
            else if (blendType == ImageBlendingColorComponentBlendType.AscendingOrder)
            {
                resultValue = (source > overlay ? overlay : source);
            }
            else if (blendType == ImageBlendingColorComponentBlendType.DescendingOrder)
            {
                resultValue = (source < overlay ? overlay : source);
            }
        ...
        /// <param name="imageDimensions">Set image dimensions</param>
        /// <returns></returns>
    ...
    /// <summary>
    /// A class collection for Bitmap Blending Filter
    /// </summary>
    [Serializable]
    public class ImageBlendingBitmapFilterData
    {
        ...
        private ImageBlendingColorComponentBlendType blendTypeBlue = ImageBlendingColorComponentBlendType.Add;

        /// <summary>
        /// Image Blue Blending
        /// </summary>
        public ImageBlendingColorComponentBlendType BlendTypeBlue { get { return blendTypeBlue; } set { blendTypeBlue = value; } }

        private ImageBlendingColorComponentBlendType blendTypeGreen = ImageBlendingColorComponentBlendType.Add;

        /// <summary>
        /// Imgage Green Blending
        /// </summary>
        public ImageBlendingColorComponentBlendType BlendTypeGreen { get { return blendTypeGreen; } set { blendTypeGreen = value; } }

        private ImageBlendingColorComponentBlendType blendTypeRed = ImageBlendingColorComponentBlendType.Add;

        /// <summary>
        /// Imgage Red Blending
        /// </summary>
        public ImageBlendingColorComponentBlendType BlendTypeRed { get { return blendTypeRed; } set { blendTypeRed = value; } }
    ...
    /// <summary>
    /// Set Image Blending Type
    /// </summary>
    public enum ImageBlendingColorComponentBlendType
    {
        Add,
        Subtract,
        Average,
