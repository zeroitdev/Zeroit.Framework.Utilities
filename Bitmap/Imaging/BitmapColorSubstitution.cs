...
// ***********************************************************************
// <copyright file="BitmapColorSubstitution.cs" company="Zeroit Dev Technologies">
...
{
    /// <summary>
    /// A class for bitmap color substitution
    /// </summary>
    public static class BitmapColorSubstitution
    {
        /// <summary>
        /// Color Substitution
        /// </summary>
        /// <param name="sourceBitmap">Set source bitmap</param>
        /// <param name="filterData">Set Color Substitution Filter</param>
        /// <returns></returns>
        public static System.Drawing.Bitmap ColorSubstitution(this System.Drawing.Bitmap sourceBitmap, ColorSubstitutionFilter filterData)
        {
