...
// ***********************************************************************
// <copyright file="OilPaintingCartoonFilter.cs" company="Zeroit Dev Technologies">
...
{
    /// <summary>
    /// A class collection for Oil Painting Cartoon Filter
    /// </summary>
    public static class OilPaintingCartoonFilter
    {
        /// <summary>
        /// Copy to canvas
        /// </summary>
        ...
        /// </summary>
        /// <param name="sourceBitmap">Set source Bitmap</param>
        /// <param name="levels">Set level</param>
        /// <param name="filterSize">Set filter size</param>
        /// <param name="threshold">Set threshold</param>
        /// <returns></returns>
        public static System.Drawing.Bitmap CartoonFilter(this System.Drawing.Bitmap sourceBitmap,
                                               int levels,
                                               int filterSize,
                                               byte threshold)
        {
            System.Drawing.Bitmap paintFilterImage = 
                   sourceBitmap.OilPaintFilter(levels, filterSize);

            System.Drawing.Bitmap edgeDetectImage = 
                sourceBitmap.OilPaintGradientBasedEdgeDetectionFilter(threshold);
        ...
        /// <param name="filterSize">Set filter size</param>
        /// <returns></returns>
        public static System.Drawing.Bitmap OilPaintFilter(this System.Drawing.Bitmap sourceBitmap,
                                               int levels,
                                               int filterSize)
        {
        ...
        /// <summary>
        /// Oil Paint Gradient Based Edge Detection Filter
        /// </summary>
        /// <param name="sourceBitmap">Set source Bitmap</param>
        /// <param name="threshold">Set threshold</param>
        /// <returns></returns>
        public static System.Drawing.Bitmap OilPaintGradientBasedEdgeDetectionFilter(
