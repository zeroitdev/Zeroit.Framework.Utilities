...
// ***********************************************************************
// <copyright file="Deflater.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Utilities.IO.Compression.Zip.Compression
{
    ...
    public class Deflater
	{
		...
		* The Deflater can do the following state transitions:
        ...
        /// </summary>
        /// <param name="lvl">the compression level, a value between NO_COMPRESSION
        /// and BEST_COMPRESSION, or DEFAULT_COMPRESSION.</param>
        ...
        /// Creates a new deflater with given compression level.
        /// </summary>
        /// <param name="level">the compression level, a value between NO_COMPRESSION
        /// and BEST_COMPRESSION.</param>
        /// <param name="noZlibHeaderOrFooter">true, if we should suppress the Zlib/RFC1950 header at the
        /// beginning and the adler checksum at the end of the output.  This is
        /// useful for the GZIP/PKZIP formats.</param>
        ...
        /// <exception cref="InvalidOperationException">finish()/end() already called</exception>
        ...
        /// <exception cref="ArgumentOutOfRangeException">lvl</exception>
        ...
        /// needsInput() or finished() returns true or length is zero.</returns>
        ...
        /// <returns>The number of compressed bytes added to the output, or 0 if either
        /// needsInput() or finished() returns true or length is zero.</returns>
        /// <exception cref="InvalidOperationException">Deflater closed</exception>
