...
// ***********************************************************************
// <copyright file="DeflaterEngine.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Utilities.IO.Compression.Zip.Compression 
{
    ...
    /// </summary>
    /// <seealso cref="Zeroit.Framework.Utilities.IO.Compression.Zip.Compression.DeflaterConstants" />
...
*/               
        ...
        /// <param name="finish">if set to <c>true</c> [finish].</param>
        /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
        /// <exception cref="InvalidOperationException">unknown comprFunc</exception>
