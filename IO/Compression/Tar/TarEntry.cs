...
// ***********************************************************************
// <copyright file="TarEntry.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Utilities.IO.Compression.Tar 
{
    ...
    /// defaults and the File is set to null.</p><see cref="TarHeader" />
    /// </summary>
    ...
    public class TarEntry : ICloneable
	{
        ...
        /// to null.
        /// </summary>
        /// <param name="headerBuf">The header bytes from a tar archive entry.</param>
        ...
        /// </summary>
        /// <param name="fileName">The file that the entry represents.</param>
        /// <returns>TarEntry.</returns>
        ...
        /// </summary>
        /// <param name="it">The <see cref="System.Object" /> to compare with this instance.</param>
        ...
        /// </summary>
        /// <param name="desc">Entry to be checked as a descendent of this.</param>
...
*/
        ...
        /// </summary>
        /// <param name="outbuf">The tar entry header buffer to fill in.</param>
