...
// ***********************************************************************
// <copyright file="TarInputStream.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Utilities.IO.Compression.Tar 
{
    ...
    public class TarInputStream : Stream
	{
        ...
        /// </summary>
        /// <param name="numToSkip">The number of bytes to skip.</param>
        ...
        /// </summary>
        /// <value><c>true</c> if this instance is mark supported; otherwise, <c>false</c>.</value>
        ...
        /// <exception cref="Zeroit.Framework.Utilities.IO.Compression.Tar.TarException">Header checksum is invalid</exception>
        /// <exception cref="Zeroit.Framework.Utilities.IO.Compression.Tar.InvalidHeaderException">
        /// Failed to read long name entry
        /// or
        /// bad header in record " + this.buffer.GetCurrentBlockNum() + " block " + this.buffer.GetCurrentBlockNum() + ", " + ex.Message
        /// </exception>
        ...
        /// </summary>
        /// <param name="outputBuffer">The buffer into which to place bytes read.</param>
        ...
        /// <exception cref="Zeroit.Framework.Utilities.IO.Compression.Tar.TarException">unexpected EOF with " + numToRead + " bytes unread</exception>
        ...
        public interface IEntryFactory
		{
            ...
            /// </summary>
            /// <param name="headerBuf">Buffer containing header information to base entry on</param>
            /// <returns>Created TarEntry or descendant class</returns>
        ...
        /// </summary>
        /// <seealso cref="Zeroit.Framework.Utilities.IO.Compression.Tar.TarInputStream.IEntryFactory" />
