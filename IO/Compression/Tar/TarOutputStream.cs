...
// ***********************************************************************
// <copyright file="TarOutputStream.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Utilities.IO.Compression.Tar 
{
    ...
    public class TarOutputStream : Stream
	{
        ...
        /// next entry written.
        /// </summary>
        /// <exception cref="Zeroit.Framework.Utilities.IO.Compression.Tar.TarException">entry closed at '" + this.currBytes + "' before the '" + this.currSize + "' bytes specified in the header were written</exception>
        ...
        /// </summary>
        /// <param name="wBuf">The buffer to write to the archive.</param>
        /// <param name="wOffset">The offset in the buffer from which to get bytes.</param>
        /// <param name="numToWrite">The number of bytes to write.</param>
        /// <exception cref="ArgumentNullException">TarOutputStream.Write buffer null</exception>
        /// <exception cref="ArgumentOutOfRangeException">request to write '" + numToWrite + "' bytes exceeds size in header of '" + this.currSize + "' bytes</exception>
