...
// ***********************************************************************
// <copyright file="TarArchive.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Utilities.IO.Compression.Tar {
    ...
    public class TarArchive
	{
        ...
        /// </summary>
        /// <param name="keepOldFiles">If true, do not overwrite existing files.</param>
        ...
        /// </summary>
        /// <param name="asciiTranslate">If true, translate ascii text files.</param>
        ...
        /// <summary>
        /// The apply user information overrides
        /// </summary>
        ...
        /// </summary>
        /// <value><c>true</c> if [apply user information overrides]; otherwise, <c>false</c>.</value>
        ...
        /// <exception cref="TarException">Exception creating directory '" + directoryName + "', " + e.Message</exception>
        ...
        /// <summary>
        /// Determines whether the specified filename is binary.
        /// </summary>
        /// <param name="filename">The filename.</param>
        /// <returns><c>true</c> if the specified filename is binary; otherwise, <c>false</c>.</returns>
