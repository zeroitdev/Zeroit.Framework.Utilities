...
namespace Zeroit.Framework.Utilities.GraphicsExtension.ThemeManagers
{
    ...
    public abstract class ThemeContainer : ContainerControl
    {
        ...
        private void InvalidateBitmap()
        {
            if (_Transparent && _ControlMode)
            {
                if (Width == 0 || Height == 0)
                    return;
                B = new System.Drawing.Bitmap(Width, Height, PixelFormat.Format32bppPArgb);
        ...
        /// The measure bitmap
        /// </summary>
        private System.Drawing.Bitmap MeasureBitmap;
    ...
    static class Helper
    {
        ...
        public static void CenterStringTab(System.Drawing.Graphics G, string text, Font font, Brush brush, Rectangle rect, bool shadow = false, int yOffset = 0)
        {
    ...
    static class Draw
    {
        ...
        /// <param name="Curve">The curve.</param>
        /// <param name="C">The c.</param>
        public static void FillRoundRect(System.Drawing.Graphics G, Rectangle R, int Curve, Color C)
        {
            using (SolidBrush B = new SolidBrush(C))
            {
        ...
        /// <param name="Curve">The curve.</param>
        /// <param name="C">The c.</param>
        public static void DrawRoundRect(System.Drawing.Graphics G, Rectangle R, int Curve, Color C)
        {
        ...
        /// <param name="p">The p.</param>
        public static void DrawRoundedRectangle(System.Drawing.Graphics g, Rectangle r, int d, Pen p)
        {
        ...
        /// <param name="width">The width.</param>
        /// <param name="height">The height.</param>
        public static void Gradient(System.Drawing.Graphics g, Color c1, Color c2, int x, int y, int width, int height)
        {
        ...
        /// <param name="c2">The c2.</param>
        /// <param name="r">The r.</param>
        public static void Gradient(System.Drawing.Graphics g, Color c1, Color c2, Rectangle r)
        {
            using (LinearGradientBrush T = new LinearGradientBrush(r, c1, c2, LinearGradientMode.Vertical))
            {
                g.FillRectangle(T, r);
        ...
        /// <param name="width">The width.</param>
        /// <param name="height">The height.</param>
        public static void Blend(System.Drawing.Graphics g, Color c1, Color c2, Color c3, float c, int d, int x, int y, int width, int height)
        {
        ...
        /// <param name="height">The height.</param>
        /// <param name="G">The g.</param>
        public static void BackGround(int width, int height, System.Drawing.Graphics G)
        {
        ...
        public static void ShadowedString(System.Drawing.Graphics g, string s, Font font, Brush brush, Point pos)
        {
        ...
        /// <param name="Rectangle">The rectangle.</param>
        /// <param name="Colors">The colors.</param>
        public static void InnerGlow(System.Drawing.Graphics G, Rectangle Rectangle, Color[] Colors)
        {
            int SubtractTwo = 1;
            int AddOne = 0;
        ...
        /// <param name="Colors">The colors.</param>
        public static void InnerGlowRounded(System.Drawing.Graphics G, Rectangle Rectangle, int Degree, Color[] Colors)
        {
            int SubtractTwo = 1;
            int AddOne = 0;
            foreach (Color c_loopVariable in Colors)
