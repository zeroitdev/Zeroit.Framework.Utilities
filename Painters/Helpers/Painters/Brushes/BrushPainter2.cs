...
namespace Zeroit.Framework.Utilities.GraphicsExtension.Painters.Editors.Brushes
{
    ...
    public class BrushPainter2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BrushPainter2"/> class.
        /// </summary>
        ...
        /// <param name="rect">Rectangle area to which fill is to be applied.</param>
        /// <returns>Brush.</returns>
        /// <remarks>The <c>rect</c> parameter only affects the brush if <c>BrushPainter2Type</c> is <c>Gradient</c>.
        /// <para>
        /// The caller is responsible for disposing of the returned brush.
        /// </para></remarks>
