...
namespace Zeroit.Framework.Utilities.GraphicsExtension.Painters.Editors
{
    ...
    public partial class ColorGradientEditor : UserControl
    {
        ...
        {
            Zeroit.Framework.Utilities.GraphicsExtension.Painters.Editors.ComboColorPickerDialog d = new Zeroit.Framework.Utilities.GraphicsExtension.Painters.Editors.ComboColorPickerDialog(colorLabel.BackColor, colorButton);
