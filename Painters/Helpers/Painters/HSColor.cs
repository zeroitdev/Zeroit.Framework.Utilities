...
namespace Zeroit.Framework.Utilities.GraphicsExtension.Painters.Editors
{
	...
	public class HSColor
	{
		...
		public static System.Drawing.Bitmap GenerateCircle(Size size,
											int innerRadius,
											int outerRadius,
											int binning,
											Color innerColor,
											...
											double val) // V in HSV, L in HSL
		{
		    ...
		    System.Drawing.Bitmap bm = new System.Drawing.Bitmap(size.Width, size.Height, PixelFormat.Format24bppRgb);
