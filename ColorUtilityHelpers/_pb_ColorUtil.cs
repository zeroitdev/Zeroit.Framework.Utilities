...
namespace Zeroit.Framework.Utilities
{
	...
	public class HsvColor
	{
		...
		{
			return ColorConverterUtil.RGBtoHSV(col);
		}
	...
	public class XYZColor
	{
		...
		{
			return ColorConverterUtil.RGBToXYZ(col);
		}

		public static XYZColor FromRGB(float R, float G, float B)
		{
			return ColorConverterUtil.RGBToXYZ(R, G, B);
		}
	...
	public class CIELabColor
	{
		...
		{
			return ColorConverterUtil.XYZToCIE_Lab(xyz);
		}
