...
// ***********************************************************************
// <copyright file="BinTree.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Utilities.SevenZip.Sdk.Compression.LZ
{
  internal class BinTree : InWindow, IMatchFinder, IInWindowStream
  {
    ...
    {
      if (historySize + 256U > (uint) int.MaxValue)
...
label_19:;
    ...
    private void Normalize()
    {
      ...
      BinTree.NormalizeLinks(this._son, this._cyclicBufferSize * 2U, subValue);
      BinTree.NormalizeLinks(this._hash, this._hashSizeSum, subValue);
