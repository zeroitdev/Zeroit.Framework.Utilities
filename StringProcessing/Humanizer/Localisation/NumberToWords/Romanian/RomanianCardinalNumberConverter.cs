...
// ***********************************************************************
// <copyright file="RomanianCardinalNumberConverter.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Utilities.StringProcessing.HumanizerLocalisation.NumberToWords.Romanian
{
    ...
    class RomanianCardinalNumberConverter
    {
        ...
        /// </summary>
        /// <param name="currentSet">The current set.</param>
        /// <returns>The next conversion function to use.</returns>
        /// <exception cref="ArgumentOutOfRangeException">Unknow ThreeDigitSet: " + currentSet</exception>
        ...
        /// <summary>
        /// Determines whether the specified number is above20.
        /// </summary>
        /// <param name="number">The number.</param>
        /// <returns><c>true</c> if the specified number is above20; otherwise, <c>false</c>.</returns>
        ...
        /// Hundredses to text.
        /// </summary>
        /// <param name="hundreds">The hundreds.</param>
        /// <returns>System.String.</returns>
